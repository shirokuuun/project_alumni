...
const EXPERTISE_OPTIONS = [
  "Web Development", "IT Sales", "Database Management",
  "Mobile Development", "Entrepreneurship", "Embedded Systems",
  "UI/UX Design", "Game Development", "IoT (Internet of Things)",
  "HR / Recruitment", "Cybersecurity", "Business Analysis",
  "Project Management", "Graphic Design", "Digital Marketing",
  "QA / Testing", "AI / Machine Learning", "Leadership / Management"
];

const FOCUS_OPTIONS = [
  "Career Planning & Pathing", "Soft Skills & Professionalism",
  "Resume & Portfolio Review", "Startup & Entrepreneurship Advice",
  "Portfolio Review", "Interview Preparation",
  "Design & UX Feedback", "Technical Skill Coaching",
  "Data & AI Guidance", "Project Guidance & Feedback",
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-6 md:p-10 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Page Title Section */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Mentor Sign-Up Form</h1>
              <p className="text-gray-500 mt-1 text-sm italic">
                Become a mentor and support junior professionals by sharing your experience and guidance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-8">
              ...
              <div className="flex items-center gap-4 mb-8 bg-gray-50 p-4 rounded-lg border border-gray-300">
                ...
                />
                <div>
                  <h2 className="text-lg font-bold text-gray-900 uppercase tracking-wide">Mark Zuckerberg</h2>
              ...
              {/* Basic Info Form Grid */}
                ...
                {/* Current role */}
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-gray-800">Current Role / Job Title</label>
                  <select 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-gray-800">Years of Experience</label>
                  <input 
                    type="text" 
                    placeholder="e.g. 5" 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-gray-800">Secondary Department</label>
                  <select 
                    className="w-full p-3 bg-gray-100 rounded-lg text-sm border border-gray-300 focus:border-yellow-500 outline-none text-gray-700 appearance-none"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-full">
                <h4 className="font-bold text-sm text-gray-800 mb-4">Area of Expertise <span className="text-gray-400 font-normal text-xs">(Select all that apply)</span></h4>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 h-full">
                <h4 className="font-bold text-sm text-gray-800 mb-4">Mentoring Focus <span className="text-gray-400 font-normal text-xs">(Select all that apply)</span></h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-6">Availability & Scheduling</h3>

                {/* Left White Card */}
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex-1">
                  
                  {/* 1. DYNAMIC DAYS SELECTOR */}
                  <h4 className="font-bold text-sm text-gray-800 mb-4">Available Days</h4>
                      ...
                      return (
                        <button
                          ...
                          className={`font-bold transition-colors ${
                            isSelected ? "text-[#eab308]" : "text-gray-400 hover:text-gray-600"
                          }`}
                        >
                          {day}
                        </button>
                  ...
                  <h4 className="font-bold text-sm text-gray-800 mb-3">Preferred Session Type</h4>
                  ...
                  {/* 3. TIME INPUTS */}
                  <h4 className="font-bold text-sm text-gray-800 mb-3">Available Time</h4>
              ...
              <div className="flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-6">Volunteer & Community Involvement</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 w-full md:w-1/2">
              <h3 className="text-lg font-bold text-gray-800 mb-4">Mentor Agreement & Guidelines</h3>
              
              <div className="space-y-4">
                <Link to="#" className="text-[#eab308] text-sm font-bold hover:underline block mb-2">
                ...
                >
                  <div className="mt-0.5 min-w-[20px]">
                    {/* DYNAMIC CHECKBOX UI */}
                    <div className={`w-5 h-5 rounded flex items-center justify-center border transition-colors ${agreementChecked ? 'bg-[#eab308] border-[#eab308]' : 'bg-white border-gray-400'}`}>
                        {agreementChecked && (
                  ...
                  <p className="text-xs text-gray-700 leading-tight">
                    I agree to follow the mentorship guidelines and maintain professional conduct throughout the mentoring engagement.
                  </p>
                </div>
...
function CheckboxOption({ label, checked, onChange }) {
  return (
    ...
    >
      <div className={`w-4 h-4 rounded-full border flex items-center justify-center flex-shrink-0 mt-0.5 transition-colors ${checked ? 'border-[#eab308]' : 'border-gray-400'}`}>
...
function RadioOption({ label, checked, onChange }) {
  return (
    ...
    >
      <div className={`w-4 h-4 rounded-full border flex items-center justify-center flex-shrink-0 transition-colors ${checked ? 'border-[#eab308]' : 'border-gray-400'}`}>
        {checked && <div className="w-2 h-2 bg-[#eab308] rounded-full"></div>}
      </div>
      <span className={`text-xs group-hover:text-gray-900 ${checked ? 'text-gray-900 font-medium' : 'text-gray-700'}`}>
        {label}
      </span>
    </div>
  );
