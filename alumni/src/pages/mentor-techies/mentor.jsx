  ...
  return (
    ...
    {/* WHAT WE DO DIFFERENTLY */}
      <section className="bg-blue-50 py-24 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1 flex flex-col justify-start">
            <span className="uppercase text-xs font-bold tracking-widest text-gray-900 mb-2">WHY US</span>
            <h2 className="text-4xl font-bold text-blue-600 mb-6 leading-tight">What we do <br/> differently</h2>
            <p className="text-gray-600 text-base leading-relaxed mb-8">
              We give you a custom experience to unlock your tech potential and start your journey to your dream job. Our program is designed to help you develop your creative skills and gain real-world experience through internships.
            </p>
          ...
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-sm hover:shadow-md transition flex flex-col h-full">
              <h3 className="font-bold text-xl text-gray-900 mb-4">Mentorship Program</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Our team of experienced mentors provide personalized guidance and support to help you reach your career goals.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-sm hover:shadow-md transition flex flex-col h-full">
              <h3 className="font-bold text-xl text-gray-900 mb-4">Internship Program</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                We offer an intensive internship program for ambitious learners looking to take their career paths to the next level.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-sm hover:shadow-md transition flex flex-col h-full">
              <h3 className="font-bold text-xl text-gray-900 mb-4">Job Search</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Our Tech recruiters provide comprehensive guidance to help individuals reach their professional goals.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl border border-gray-300 shadow-sm hover:shadow-md transition flex flex-col h-full">
              <h3 className="font-bold text-xl text-gray-900 mb-4">Networking</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                We have the perfect place to connect with industry professionals and find mentors in the fields of tech and IT.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
            <span className="uppercase text-xs font-bold tracking-widest text-gray-500">About Us</span>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-blue-600 mb-16">Be Job Ready in 4 Steps</h2>
      ...
      <section className="bg-blue-50 py-20 px-6 text-center">
        <h2 className="text-4xl font-bold text-blue-600 mb-4">We have experts to give you <br/> professional mentoring</h2>
        ...
        <p className="mt-15 text-gray-600 text-sm">Our top mentors will provide you with the guidance and resources and resources you need to reach your goals.</p>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-gray-900 mb-12">Testimonials from our Mentees</h2>
...
function StepCard({ number, title, color, desc }) {
    return (
        <div className="text-left flex flex-col h-full">
            {/* Number Box */}
            <div className={`w-12 h-12 ${color} text-white font-bold text-lg flex items-center justify-center rounded-lg mb-4 shadow-sm`}>
                {number}
            </div>
...
function MentorCard({ name, role, img }) {
    return (
        <div className="flex flex-col items-center">
            <img src={img} alt={name} className="w-40 h-40 rounded-full object-cover mb-4 border-4 border-white shadow-md" />
...
function TestimonialCard({ quote, name, role, imageSrc }) {
  return (
    <div className="bg-blue-50 p-8 rounded-2xl relative bborder border-black-400 shadow-sm hover:shadow-md transition">
       {/* Large Quote Icon */}
       <span className="absolute top-4 left-4 text-6xl text-blue-200 opacity-100 font-serif leading-none">“</span>
